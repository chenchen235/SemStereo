...
class Us3dDataset(Dataset):
    ...
    def load_image(self, filename):
        ...
        # image = cv2.imread(filename, cv2.IMREAD_UNCHANGED).convert('RGB').astype('float32') / 127.5 - 1.0
        # return image
    ...
    def __getitem__(self, index):
        ...
        #label = self.load_label(os.path.join(self.datapath, self.disp_filenames[index]))
